...
all: data_buffer_tb simple_counter_tb write_controller_tb readout_controller_tb data_writer_tb eeprom_controller_tb

eeprom_controller_tb: rtl/eeprom/eeprom_controller.vhd test/eeprom_controller_tb.vhd
	ghdl -a $(GHDL_OPTS) $^
	ghdl -e $(GHDL_OPTS) $@
