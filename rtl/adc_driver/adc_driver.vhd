...
-- Module  Version: 5.8
--/usr/local/diamond/3.10_x64/ispfpga/bin/lin64/scuba -w -n adc_driver -lang vhdl -synth lse -bus_exp 7 -bb -arch sa5p00 -type iol -mode Receive -io_type LVDS -width 12 -freq_in 250 -gear 4 -del 128 -fdc /home/themba/synced/auger-radio-extension/rtl/adc_driver/adc_driver.fdc 

-- Thu Apr 25 13:15:56 2019
...
begin
    ...
    Inst3_ECLKSYNCB: ECLKSYNCB
        port map (ECLKI=>eclki, STOP=>stop, ECLKO=>eclko);
    ...
    udel_dataini11: DELAYG
        generic map (DEL_MODE=> "ECLK_CENTERED")
