...
-- Module  Version: 5.8
--/usr/local/diamond/3.10_x64/ispfpga/bin/lin64/scuba -w -n adc_driver -lang vhdl -synth lse -bus_exp 7 -bb -arch sa5p00 -type iol -mode Receive -io_type LVDS -width 15 -freq_in 200 -gear 2 -del 128 -fdc /home/rjordans/SurfDrive/Projects/RadboudRadioLab/Auger/auger-radio-extension/rtl/adc_driver/adc_driver.fdc 

-- Tue Aug 14 14:06:53 2018
...
architecture Structure of adc_driver is
    ...
    attribute IO_TYPE of Inst1_IB14 : label is "LVDS";
    attribute IO_TYPE of Inst1_IB13 : label is "LVDS";
...
begin
    ...
    Inst2_IDDRX1F14: IDDRX1F
        port map (D=>dataini_t14, SCLK=>sclk_t, RST=>reset, Q0=>qa14, 
            Q1=>qb14);

    Inst2_IDDRX1F13: IDDRX1F
        port map (D=>dataini_t13, SCLK=>sclk_t, RST=>reset, Q0=>qa13, 
            Q1=>qb13);

    Inst2_IDDRX1F12: IDDRX1F
        port map (D=>dataini_t12, SCLK=>sclk_t, RST=>reset, Q0=>qa12, 
            Q1=>qb12);
    ...
    udel_dataini14: DELAYG
        generic map (DEL_MODE=> "SCLK_CENTERED")
        port map (A=>buf_dataini14, Z=>dataini_t14);

    udel_dataini13: DELAYG
        generic map (DEL_MODE=> "SCLK_CENTERED")
        port map (A=>buf_dataini13, Z=>dataini_t13);
