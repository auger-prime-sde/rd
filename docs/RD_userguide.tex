...
\acrodef{FFT}{fast fourrier transform}
...
\begin{tabular}{|r|r|l|l|}
  ...
  \hline
  %159 - 152 & sub-system address, not part of re
...
\begin{center}
  ...
  \end{tikztimingtable}
  \captionof{figure}{Example of calibration data readout.}
\end{center}
...
\begin{center}
  ...
  \end{tikztimingtable}
  \captionof{figure}{Setting the \acs{DAC} output using \acs{SPI}.}
\end{center}
